            ...
            <div className="bg-white rounded-lg shadow p-4 mb-6">
              ...
              <div className="grid grid-cols-3 md:grid-cols-6 gap-4 text-center">
                ...
                <div className="bg-green-100 rounded p-3">
                  ...
                  <p className="text-xs text-gray-600">A計</p>
                </div>
                ...
                <div className="bg-green-50 rounded p-3">
                  ...
                  <p className="text-xs text-gray-600">A3</p>
                </div>
                ...
                <table className="w-full text-sm">
                  <thead className="bg-gray-100">
                    <tr>
                      ...
                      {TIME_SLOTS.map((slot) => (
                        <th key={slot} colSpan={4} className="px-3 py-2 text-center border-l">
                          {slot}
                        </th>
                      ))}
                      <th colSpan={4} className="px-3 py-2 text-center border-l bg-gray-200">
                        日計
                      </th>
                    </tr>
